		...
		<section id="services" className={styles.services_section}>
			...
			<ul className={styles.services_list}>
				<li>
					...
					<p>
						Consultoria para otimizar resultados, melhorar processos e aumentar
						a lucratividade com soluções eficazes.
					</p>
				</li>
				<li>
				...
				<li>
					...
					<p>
						...
						sucesso profissional, com abordagem prática e baseada em ciência.
					</p>
				</li>
			</ul>
		</section>
